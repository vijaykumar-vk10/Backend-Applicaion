...
/* Create Result */
var mangementCreateResult = async function (Request, Response, connection, ACCESS_TOKEN,ACCESS_TOKEN_DECODED) {
    try {
        ...
        if (fetchManagementOuput.error != null || fetchManagementOuput.response.payLoad.length) {
            throw {"code": "FST105F", "message": "Managment Fetch - DB Error", "statusCode": 500}
        }
        if(fetchManagementOuput.response.payLoad[0].schoolID != resultData.schoolID){
...
module.exports = mangementCreateResult