/**
 * @name Management
 * @description Management Delete Result flow
 * @author vijaykumar
 * @version 1.0
 */
...
/* Delete Result */
var managementDeleteResults = async function (Request, Response, connection) {
    try {
         ...
         *  1. subjectname of the Management User in the Request Locals
...
module.exports = managementDeleteResults