/**
 * @name Management
 * @description Management Update Result flow
 * @author Vijaykumar
 * @version 1.0
 */
...
/* Create Reuslt */
var managementUpdateResults = async function (Request, Response, connection, ACCESS_TOKEN, ACCESS_TOKEN_DECODED) {
    try {
        ...
        if(fetchManagementOuput.response.payLoad[0].schoolID != Request.body.payLoad.schoolID){
...
module.exports = managementUpdateResults