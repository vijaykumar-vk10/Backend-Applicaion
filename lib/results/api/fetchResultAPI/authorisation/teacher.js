/**
 * @name teacher
 * @description teacher Fetch Result flow
 * @author Vijaykumar
 * @version 1.0
 */
...
/* Fetch Result */
var teacherFetchResult = async function (Request, Response, connection, ACCESS_TOKEN, ACCESS_TOKEN_DECODED) {
    try {
        ...
        ResultQuery["teacherID"] = fetchteacherOuput.response.payLoad[0].teacherID
...
module.exports = teacherFetchResult